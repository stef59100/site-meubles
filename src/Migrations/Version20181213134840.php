 ...
 */
final class Version20181213134840 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE products ADD product_price DOUBLE PRECISION NOT NULL, ADD tax DOUBLE PRECISION NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE products DROP product_price, DROP tax');
    }
}
